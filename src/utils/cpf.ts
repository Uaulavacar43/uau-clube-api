...
export const verifierDigitCpf = verifierDigit;
export const stripCpf = strip;
export const formatCpf = format;
export const isValidCpf = isValid;
export const generateCpf = generate;
