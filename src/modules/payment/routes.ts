...
import { ActivateSubscriptionSchema } from "./dto/ActivateSubscriptionDTO";
...
router.post(
	...
	authMiddleware,
	validateRoutePayload(ActivateSubscriptionSchema),
	(req, res, next) => paymentController.activateSubscription(req, res, next),
);
